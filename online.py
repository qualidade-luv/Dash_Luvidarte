...
ABAS = {
    ...
    'FERRAMENTARIA': 'FM',
    'PRÊMIO PRENSADOS': 'PP',
    'REPASSES DE PRODUÇÃO': 'RP'  # <-- NOVA ABA ADICIONADA
}
    ...
    def carregar_carteira_pedidos() -> pd.DataFrame:
        ...
        try:
            ...
            for col in colunas_esperadas:
                # Tentar encontrar a coluna mesmo com pequenas variações
                col_encontrada = None
                ...
                if col_encontrada:
                    ...
                    for col_df in df.columns:
                        if col_df.startswith(col) or col.startswith(col_df):
                            colunas_existentes.append(col_df)
                            break
